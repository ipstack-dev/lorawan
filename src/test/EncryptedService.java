...
public class EncryptedService implements DataService {
	
	public static boolean VERBODE=true;
	
	private static void log(String str) {
		System.out.println("DEBUG: "+EncryptedService.class.getSimpleName()+": "+str);
	}
	...
	public EncryptedService(DataService service, byte[] key) {
