...
/** Payload of a Join Accept message.
 */
public class LorawanJoinAcceptMessagePayload {
	...
	public LorawanJoinAcceptMessagePayload(byte[] joinNonce, byte[] homeNetId, byte[] devAddr, int dlSettings, int rxDelay, byte[] cfList) {
	...
	public LorawanJoinAcceptMessagePayload(byte[] data) {
	...
	public LorawanJoinAcceptMessagePayload(byte[] buf, int off, int len) {
	...
	public String toString(String delim) {
		...
		String homeNetId=Bytes.toHex(getHomeNetID());
